const CACHE_NAME='bmw-pwa-v7-no-maskable-sweep-fix';
const APP_SHELL=[
 './index.html?v=7',
 './manifest.webmanifest?v=7',
 './icons/bmw-v6-icon-180.png?v=7',
 './icons/bmw-v6-icon-192.png?v=7',
 './icons/bmw-v6-icon-512.png?v=7',
